...
public class ImageController {
    ...
    @RequestMapping("/images/{title}/{date}")
    public String showImage(@PathVariable("title") String title, @PathVariable("date") Timestamp date, Model model) {
        Image image = imageService.getImageByTitle(title,date);
